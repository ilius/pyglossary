...
setup(
	...
	data_files   = [("share/applications",["pyglossary.desktop"]),
	                ("share/pyglossary",["src/about","src/license","src/help","src/rc.py"]),
	                ("share/pyglossary/glade",glob.glob("src/glade/*")),
	                ("share/pyglossary/ui",glob.glob("src/ui/*")),
	                ("share/pyglossary/django",glob.glob("src/django/*")),
	                ("share/pyglossary/res",glob.glob("src/res/*")),
	                ("share/pyglossary/plugins",glob.glob("src/plugins/*")),
	                ("share/pixmaps",["src/res/pyglossary.png"])],
	**py2exeoptions
)
