...
- Mobipocket: refactor, run kindlegen with relative file path, [#613](https://github.com/ilius/pyglossary/issues/613)
- Add back `pkg/pyglossary.desktop` for flathub build, [#614](https://github.com/ilius/pyglossary/issues/614)
- Rename plugin `ABCMedicalNotes` to `MakindoMedical` ([#267](https://github.com/ilius/pyglossary/pull/267))
