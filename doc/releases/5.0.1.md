...
- Web UI: add `setup.py `metadata by [@glowinthedark](https://github.com/glowinthedark) in PR [#609](https://github.com/ilius/pyglossary/pull/609) by [@glowinthedark](https://github.com/glowinthedark)
