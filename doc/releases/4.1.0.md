...
- Fixes and improvements code base
  ...
  - Refactor `dataDir` detection, [#307](https://github.com/ilius/pyglossary/issues/307) PR [#316](https://github.com/ilius/pyglossary/pull/316) by [@germn](https://github.com/germn)
...
- Fixes and improvements in Windows
  ...
  - Fix dataDir detection on Windows, [#323](https://github.com/ilius/pyglossary/issues/323) [#324](https://github.com/ilius/pyglossary/issues/324)
...
- XDXF
  ...
  * `xdxf_transform.py`: remove warnings for <opt>, [#322](https://github.com/ilius/pyglossary/issues/322)
  ...
  - Merge PR [#317](https://github.com/ilius/pyglossary/pull/317) by [@ashwinvis](https://github.com/ashwinvis)
...
- Mobi
  ...
  - Add PR [#335](https://github.com/ilius/pyglossary/pull/335) by [@Mumumu4](https://github.com/Mumumu4) with some modifications
...
- CC-CEDICT Reader:
  ...
  - Switch from jinja2 to lxml
    ...
    - Note: lxml inserts the decimal non-breaking-space entity (`&#160;`) instead of `&nbsp;`
