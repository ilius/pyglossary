...
- Fixes in ui_gtk, [#380](https://github.com/ilius/pyglossary/issues/380) [#382](https://github.com/ilius/pyglossary/issues/382) [#403](https://github.com/ilius/pyglossary/issues/403)
...
- Add support for writing Yomichan dictionary files, [#395](https://github.com/ilius/pyglossary/issues/395) by [@tomtung](https://github.com/tomtung)
...
- When remove HTML tags, also replace `<div>` with `\n`, [#394](https://github.com/ilius/pyglossary/issues/394) by [@tomtung](https://github.com/tomtung)

  - Treat `<div>` the same way `<p>` is treated.

- Mobi: add `mobi7-forcing` switch to `kindlegen` command, [#374](https://github.com/ilius/pyglossary/issues/374) by [@holyspiritomb](https://github.com/holyspiritomb)
...
- Add SVG icon, [#414](https://github.com/ilius/pyglossary/issues/414) by [@proletarius101](https://github.com/proletarius101)
...
- Support MDict V3 fomrat by updating `readmdict`, [#385](https://github.com/ilius/pyglossary/issues/385) by [@xiaoqiangwang](https://github.com/xiaoqiangwang)

- Fix files created without UUID in header, [#387](https://github.com/ilius/pyglossary/issues/387) by [@xiaoqiangwang](https://github.com/xiaoqiangwang)

  - MdxBuilder 4.0 RC2 and before creates files without UUID header

- Decode mdict title & description if they're bytes, [#393](https://github.com/ilius/pyglossary/issues/393) by [@tomtung](https://github.com/tomtung)
...
- `readmdict`: improve exception msg for xxhash, [#385](https://github.com/ilius/pyglossary/issues/385)
...
- Fixes from PR [#436](https://github.com/ilius/pyglossary/pull/436)

- Support morphology (alternates): [#434](https://github.com/ilius/pyglossary/issues/434) by [@soshial](https://github.com/soshial)

- Support different AppleDict offsets, [#417](https://github.com/ilius/pyglossary/issues/417) by [@soshial](https://github.com/soshial)

- Extract AppleDict meta-info (langs, title, author), [#418](https://github.com/ilius/pyglossary/issues/418) by [@soshial](https://github.com/soshial)
