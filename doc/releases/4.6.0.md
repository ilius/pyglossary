...
- dictunformat: fix [#367](https://github.com/ilius/pyglossary/issues/367): add option `headword_separator`, default to `;   `

- Fixes in ui_gtk, PR [#380](https://github.com/ilius/pyglossary/pull/380) by [@Eloston](https://github.com/Eloston) [#382](https://github.com/ilius/pyglossary/issues/382) [#403](https://github.com/ilius/pyglossary/issues/403)

- AppleDict source: fix [#407](https://github.com/ilius/pyglossary/issues/407) missing quotes for title, and refactor duplicate codes
...
- Fix bug of `glos.addEntryObj(dataEntry)` adding empty file because `tmpDataDir` is not set until `glos.read()`
  ...
  - Set and create `tmpDataDir` on `glos.tmpDataDir` access, and add test, [#424](https://github.com/ilius/pyglossary/issues/424)

- Fix `scripts/wiki-formats.py`, [#428](https://github.com/ilius/pyglossary/issues/428)
...
- Add read and write support for StarDict Textual File (.xml), [#348](https://github.com/ilius/pyglossary/issues/348)

- Add support for writing Yomichan dictionary files, PR [#395](https://github.com/ilius/pyglossary/pull/395) by [@tomtung](https://github.com/tomtung)

- StarDict reader: support `.syn.dz` file, [#410](https://github.com/ilius/pyglossary/issues/410)

- StarDict writer: add write option `large_file`, [#392](https://github.com/ilius/pyglossary/issues/392) [#422](https://github.com/ilius/pyglossary/issues/422)

- StarDict reader: support `dxoffsetbits=64` on read, [#392](https://github.com/ilius/pyglossary/issues/392) [#422](https://github.com/ilius/pyglossary/issues/422)

- JMDict: support examples, [#383](https://github.com/ilius/pyglossary/issues/383)

- Add read support for JMnedict, [#386](https://github.com/ilius/pyglossary/issues/386)

- Add flag `--skip-duplicate-headword`, config `skip_duplicate_headword`, [#365](https://github.com/ilius/pyglossary/issues/365)

  - Zim reader: remove option `skip_duplicate_words`, [#365](https://github.com/ilius/pyglossary/issues/365)

- Add flag `--trim-arabic-diacritics`, config `trim_arabic_diacritics`, [#366](https://github.com/ilius/pyglossary/issues/366)

- Add read support for IUPAC goldbook (.xml), [#355](https://github.com/ilius/pyglossary/issues/355)

- Add write support for [DIKT](https://github.com/maxim-saplin/dikt) JSON

- StarDict writer: limit memory usage by using SQLite for `idx` and `syn` data, [#409](https://github.com/ilius/pyglossary/issues/409)
...
- When remove HTML tags, also replace `<div>` with `\n`, PR [#394](https://github.com/ilius/pyglossary/pull/394) by [@tomtung](https://github.com/tomtung)

  - Treat `<div>` the same way `<p>` is treated.

- Mobi: add `mobi7-forcing` switch to `kindlegen` command, PR [#374](https://github.com/ilius/pyglossary/pull/374) by [@holyspiritomb](https://github.com/holyspiritomb)

- Octopus MDict: ignore directories with `same_dir_data_files`, [#362](https://github.com/ilius/pyglossary/issues/362)
...
- `ebook_base.py`: avoid `shutil.move` on Windows, [#368](https://github.com/ilius/pyglossary/issues/368)

- `TextGlossaryReader`: fix loading info and some refactoring, [#370](https://github.com/ilius/pyglossary/issues/370) 36b9cd83d4c79b32e34bf64c3101cb89093b2a4e
...
- Mobi: work with kindlegen executable in `PATH` directories, [#401](https://github.com/ilius/pyglossary/issues/401)
...
- Add SVG icon, PR [#414](https://github.com/ilius/pyglossary/pull/414) by [@proletarius101](https://github.com/proletarius101)

- Prevent exception/traceback on Ctrl+C

- Optimize progress bar

- Aard2 slob: show info log before and after `slobWriter.finalize()`, [#437](https://github.com/ilius/pyglossary/issues/437)

## Removed features

- Remove read support for Wiktiomary Dump, [#48](https://github.com/ilius/pyglossary/issues/48)

- Remove support for Sdictionary Binary and Source

## Octopus MDict MDX: features and improvements

- Support MDict V3 fomrat by updating `readmdict`, PR [#385](https://github.com/ilius/pyglossary/pull/385) by [@xiaoqiangwang](https://github.com/xiaoqiangwang)

- Fix files created without UUID in header, PR [#387](https://github.com/ilius/pyglossary/pull/387) by [@xiaoqiangwang](https://github.com/xiaoqiangwang)

  - MdxBuilder 4.0 RC2 and before creates files without UUID header

- Decode mdict title & description if they're bytes, PR [#393](https://github.com/ilius/pyglossary/pull/393) by [@tomtung](https://github.com/tomtung)

- `readmdict`: Skip zlib decompress exceptions, [#384](https://github.com/ilius/pyglossary/issues/384)

- `readmdict`: Use `__name__` as logger name, and add 2 debug logs, [#384](https://github.com/ilius/pyglossary/issues/384)

- `readmdict`: improve exception msg for xxhash, PR [#385](https://github.com/ilius/pyglossary/pull/385) by [@xiaoqiangwang](https://github.com/xiaoqiangwang)

## XDXF: fixes / imrovements, issue [#376](https://github.com/ilius/pyglossary/issues/376)
...
- Support any tag/string in `<ex>`, [#396](https://github.com/ilius/pyglossary/issues/396)
...
- Fix internal links, [#343](https://github.com/ilius/pyglossary/issues/343)
...
- Fixes from PR [#436](https://github.com/ilius/pyglossary/pull/436) by [@soshial](https://github.com/soshial)

- Support morphology (alternates): PR [#434](https://github.com/ilius/pyglossary/pull/434) by [@soshial](https://github.com/soshial)

- Support different AppleDict offsets, PR [#417](https://github.com/ilius/pyglossary/pull/417) by [@soshial](https://github.com/soshial)

- Extract AppleDict meta-info (langs, title, author), PR [#418](https://github.com/ilius/pyglossary/pull/418) by [@soshial](https://github.com/soshial)
...
- `README.md`: Add document for adding data entries, [#412](https://github.com/ilius/pyglossary/issues/412)

- `README.md`: Fix -> nixos command, [#400](https://github.com/ilius/pyglossary/issues/400) by [@srghma](https://github.com/srghma)
