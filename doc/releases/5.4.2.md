...
- Web UI (`--ui=web`): add file picker, PR [#728](https://github.com/ilius/pyglossary/pull/728) by [@glowinthedark](https://github.com/glowinthedark)
...
- Aard2 slob: add audio format support for m4a, m4b, aac, webm, PR [#731](https://github.com/ilius/pyglossary/pull/731) by [@glowinthedark](https://github.com/glowinthedark)

### Other changes

- Replace broken link for `python-lzo` Windows installation, PR [#729](https://github.com/ilius/pyglossary/pull/729) by [@glowinthedark](https://github.com/glowinthedark), by @glowinthedark
