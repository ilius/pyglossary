...
We have a web-based user interface by [@glowinthedark](https://github.com/glowinthedark), a new plugin [StardictMergeSyns](https://github.com/ilius/pyglossary/blob/master/doc/p/stardict_merge_syns.md), new options in  various plugins/formats, lots of improvements, refactoring and cleanup.

**Full Changelog**: https://github.com/ilius/pyglossary/compare/4.7.1...5.0.0

## New Contributors

- [@a1ess](https://github.com/a1ess) made their first contribution in PR [#590](https://github.com/ilius/pyglossary/pull/590)
