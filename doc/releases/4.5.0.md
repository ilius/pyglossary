...
- Fixes and improvements in Dictfile (.df) reader
  ...
  - Remove extra colon, [#358](https://github.com/ilius/pyglossary/issues/358)
...
- Fix `logging.warn` method is deprecated, use `warning` instead, PR [#360](https://github.com/ilius/pyglossary/pull/360) by [@BoboTiG](https://github.com/BoboTiG)

- Fix `DeprecationWarning: invalid escape sequence`, PR [#361](https://github.com/ilius/pyglossary/pull/361) by [@BoboTiG](https://github.com/BoboTiG)
