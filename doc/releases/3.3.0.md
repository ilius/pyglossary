...
- StarDict plugin
  ...
  - Fix output filenames without .ifo extension creating hidden files, PR [#187](https://github.com/ilius/pyglossary/pull/187) by [@h-c-mueller](https://github.com/h-c-mueller)
...
- AppleDict plugin:
  ...
  - Fix `echo` problem in `Makefile`, PR [#177](https://github.com/ilius/pyglossary/pull/177) by [@tsihyoung](https://github.com/tsihyoung)
  - Add dark mode support for AppleDict output, PR [#177](https://github.com/ilius/pyglossary/pull/177) by [@tsihyoung](https://github.com/tsihyoung)
...
- Update setup.py to adapt packaging with wheel, PR [#189](https://github.com/ilius/pyglossary/pull/189) by [@emfox](https://github.com/emfox)
