...
- Aard2 slob writer: add opus, oga extensions, PR [#618](https://github.com/ilius/pyglossary/pull/618) by [@glowinthedark](https://github.com/glowinthedark) by [@glowinthedark](https://github.com/glowinthedark)
- Aard2 slob writer: change "already exists" exception to `WriteError` to avoid showing stacktrace
- AppleDict writer: Russian index: switch to `pymorphy3`, [#620](https://github.com/ilius/pyglossary/issues/620)
