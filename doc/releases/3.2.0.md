...
- Add read support for CC-CEDICT plugin
  ...
  - Pull request [#140](https://github.com/ilius/pyglossary/pull/140) by [@hmgqzx](https://github.com/hmgqzx), with some fixes and improvements by me
...
- Improvement in Gtk interface:
  ...
  - Avoid changing Format combobox based on file extension if a format is already selected, PR [#141](https://github.com/ilius/pyglossary/pull/141) by [@sarahzrf](https://github.com/sarahzrf)
