...
01b56060 Yomichan: merge entries with same headword, [#574](https://github.com/ilius/pyglossary/issues/574)
5fe93f4b Yomichan: add beautifulsoup4 to dependencies, [#577](https://github.com/ilius/pyglossary/issues/577)
2a239662 use `python3` in scripts/view-glossary and scripts/diff-glossary to bypass pyenv
c878cbd5 zimfile: replace OSError on Windows with a warning, [#580](https://github.com/ilius/pyglossary/issues/580)
1573d5cf Wiktextract: rewrite writeSenseExample and fix [#572](https://github.com/ilius/pyglossary/issues/572) - Fix TypeError: got invalid input value of type `<class 'list'>` - Create a list of examples - Add the example type as prefix in bold
7f64af55 Wiktextract: keep warnings in a Counter, remove duplicate messages and show at end

## New Features

aa6765b9 add new plugin xdxf_css (XdxfCss) based on PR [#570](https://github.com/ilius/pyglossary/pull/570) by [@soshial](https://github.com/soshial)
0e9d2210 add read_options to .info file
fea2223b StarDict Textual writer: save resource files in res/ folder, [#558](https://github.com/ilius/pyglossary/issues/558)
3800fac9 add Dyula language, [#575](https://github.com/ilius/pyglossary/issues/575)
