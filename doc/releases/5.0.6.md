...
- Fix `UnicodeEncodeError` with non-utf8 stdout in frozen envs by [@glowinthedark](https://github.com/glowinthedark) in [#617](https://github.com/ilius/pyglossary/pull/617)
