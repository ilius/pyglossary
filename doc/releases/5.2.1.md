...
- Glossary: write: avoid removing trailing slash from filename
  Allow converting to a directory with StarDict, [#694](https://github.com/ilius/pyglossary/issues/694)

- StarDict writer:

  - Remove existing `.dict.dz`, `.syn.dz`, `.syn`, `syn.oft`, `.idx.oft`, [#694](https://github.com/ilius/pyglossary/issues/694)
  - Bugfix/feature: add a new option `dictzip_syn = False`, [#694](https://github.com/ilius/pyglossary/issues/694)
