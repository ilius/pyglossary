...
- [CSV](/doc/p/csv.md) reader: fix progress reporting when loading many bundled resource files, PR [#725](https://github.com/ilius/pyglossary/pull/725) by [@glowinthedark](https://github.com/glowinthedark)
- [CSV](/doc/p/csv.md) reader: load resources from subdirectories under the resource directory, PR [#725](https://github.com/ilius/pyglossary/pull/725) by [@glowinthedark](https://github.com/glowinthedark)
