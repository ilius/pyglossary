...
from os.path import basename, dirname, extsep, isdir, isfile, splitext
from struct import pack, unpack

p_dir = os.path.abspath(os.path.join(os.getcwd(), os.pardir))
sys.path.insert(0, f'{p_dir}')
...
if __name__ == '__main__':
    ...
    if args.extract:
        ...
        if _mdd:
            for mdd in _mdd:
                datafolder = os.path.join(os.path.dirname(args.filename),
                                          args.datafolder)
