...
# NO NEED: **already** patched upstream: https://github.com/Nuitka/Nuitka/blob/develop/nuitka/plugins/standard/TkinterPlugin.py#L81
# NOT removing code in case of a future tk version bump
# plugin_path = Path(
