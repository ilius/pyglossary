...
class GetPrefixTest(unittest.TestCase):
	...
	def test_examples(self: "typing.Self"):
	...
	def test_dicthtml_en(self: "typing.Self"):
		self.case("a-", "11")
		self.case("-an", "11")
		self.case("GB", "gb")

	def test_dicthtml_fr(self: "typing.Self"):
		self.case("ébahir", "éb")
		self.case("a1", "11")
		self.case("ô", "ôa")
		self.case("kébab", "ké")
	...
	def test_dictword_spaces(self: "typing.Self"):
	...
	def test_dictword_cyrillic(self: "typing.Self"):
	...
	def test_dictword_uppercase_accented(self: "typing.Self"):
	...
	def test_dictword_cjk(self: "typing.Self"):
	...
	def test_dictword_misc(self: "typing.Self"):
	...
	def test_synthetic(self: "typing.Self"):
		self.case("x\x00y", "xa")
		self.case("\x00xy", "11")
