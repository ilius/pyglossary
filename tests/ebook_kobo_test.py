...
class GetPrefixTest(unittest.TestCase):
	...
	def test_examples(self):
		...
		# the following examples diverge from the dictutil examples
		# since kanji/hanzi use single character prefix (not 2 characters)
		self.case("未未", "未")
		self.case("未", "未")
		self.case("  未", "11")
		self.case(" 未", "未")
	...
	def test_dictword_kana(self):
		# custom examples (not generated by dictword-test as it does not handle cjk properly)
		# hiragana
		self.case(" あ", "ア")
		self.case(" あの", "ア")
		self.case("あ", "ア")
