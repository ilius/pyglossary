...
class TestGlossaryErrors(TestGlossaryErrorsBase):
	...
	def test_read_typeErr_1(self: "typing.Self"):
		glos = Glossary()
		try:
			glos.read(
				filename=MyStr(""),
	...
	def test_read_typeErr_2(self: "typing.Self"):
		glos = Glossary()
		try:
			glos.read(
				filename="",
	...
	def test_collectDefiFormat_direct(self: "typing.Self"):
		fname = "100-en-fa.txt"
		glos = self.glos = Glossary()
	...
	def test_sortWords_invalidSortKeyName(self: "typing.Self"):
		glos = self.glos = Glossary()
		glos.sortWords(
			sortKeyName="blah",
		)
