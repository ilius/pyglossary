...
class Glossary(GlossaryInfo, GlossaryProgress, PluginManager):  # noqa: PLR0904

	"""
	These methods do not exist in glossary_v2.py and glossary_v3.py.
	but still exist in glossary.py
	...
	def _prepareEntryFilters(self) -> None:
		"""
	...
	def _loadReader(self, reader: Any) -> None:  # noqa: ANN401
		"""
...
class GlossaryConvertor(Glossary):
	def convert(self, args: ConvertArgs) -> str:
		"""
...
class GlossaryCreator(Glossary):
